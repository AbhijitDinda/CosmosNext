...
import ExecutiveLeadershipDataTable from "./(components)/executiveLeadershipDataTable";
import ExecutiveLeadershipAddForm from "./(components)/executiveLeadershipAddForm";
...
const SituationalJudgement = () => {
  ...
  const { isLoading, isFetching, error, assessmentByIdData, refetch } =
  ...
  return (
    <div className="rounded-sm mx-auto w-full max-w-[1300px]">
      <Heading title="Executive Leadership Roles" />
      <div className="p-4 bg-White rounded-sm">
        <Tabs
