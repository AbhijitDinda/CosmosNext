...
import EmotionalIntelligenceEditForm from "@/pages/test-groups/action/emotional-intelligence/(components)/EmotionalIntelligenceEditForm";
import {
  flexRender,
  getCoreRowModel,
        ...
        <DialogContent className="max-h-[80vh] overflow-y-auto max-w-[600px]">
          ...
          <div className="flex justify-end p-4 space-x-2">
            ...
            <Button
              ...
              disabled={pendingDeleteQuestion || pendingDeleteStyle}
            >
              {pendingDeleteQuestion || pendingDeleteStyle
                ? "Deleting..."
                : "Delete"}
            </Button>
          </div>
