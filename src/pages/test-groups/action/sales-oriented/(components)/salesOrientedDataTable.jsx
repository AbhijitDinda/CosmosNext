...
import SalesOrientedEditForm from "./salesOrientedEditForm";
const SalesOrientedDataTable = ({ moduleType, moduleData, refetch }) => {
...
export default SalesOrientedDataTable;
