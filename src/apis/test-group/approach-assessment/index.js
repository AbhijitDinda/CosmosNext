...
export const addStyleInApproach = async ({ token , logout, post_data}) => {
    try {
        const response = await axios.post(`/admin/approach-assessment/approach-styles/add`,post_data , {
            headers: {
...
export const addQuestionInApproach = async ({ token, logout, post_data }) => {
    try {
        const response = await axios.post(`/admin/approach-assessment/questions/add`, post_data, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
...
export const editStyleInApproach = async ({ token, logout, post_data, id }) => {
    try {
        const response = await axios.put(`/admin/approach-assessment/approach-styles/update/${id}`, post_data, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
...
export const editQuestionInApproach = async ({ token, logout, post_data, id }) => {
    try {
        const response = await axios.put(`/admin/approach-assessment/questions/update/${id}`, post_data, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
...
export const deleteStyleInApproach = async ({ token, logout, id }) => {
    try {
        const response = await axios.delete(`/admin/approach-assessment/approach-styles/delete/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
...
export const deleteQuestionInApproach = async ({ token, logout, id }) => {
    try {
        const response = await axios.delete(`/admin/approach-assessment/questions/delete/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
...
export const getStyleById = async ({ token, logout, id }) => {
    try {
        const response = await axios.get(`/admin/approach-assessment/approach-styles/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
...
export const getQuestionById = async ({ token, logout, id }) => {
    try {
        const response = await axios.get(`/admin/approach-assessment/questions/${id}`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
...
export const getListOfStyles = async ({ token, logout }) => {
    try {
        const response = await axios.get(`/admin/approach-assessment/approach-styles`, {
            headers: {
                'Authorization': `Bearer ${token}`,
                'Accept': 'application/json'
            }
