...
//add
export const addQuestionInLeadershipStyle = async ({token,logout,post_data}) => {
  try {
...
export const addStyleInLeadershipStyle = async ({token, logout, post_data}) => {
    try {
        const response = await axios.post(
...
export const updateQuestionInLeadershipStyle = async ({ token, logout, post_data, questionId }) => {
    try {
...
export const updateStyleInLeadershipStyle = async ({ token, logout, post_data, styleId }) => {
    try {
        const response = await axios.patch(
...
//delete
export const deleteStyleInLeadershipStyle = async ({ token, logout, styleId }) => {
    try {
...
export const deleteQuestionInLeadershipStyle = async ({ token, logout, questionId }) => {
    try {
        const response = await axios.delete(
